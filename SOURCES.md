...
本專案的 Quantumult X 程式碼為獨立編寫。下列公開 GitHub 儲存庫僅用於研究 Quantumult X 設定形式、了解相關網路詞彙，以及協助維護本機過濾詞彙清單。
...
| [person-without-name/AntiChinaFeminist](https://github.com/person-without-name/AntiChinaFeminist) | 公開詞彙與用語線索 |
| [FemRun/FemRun](https://github.com/FemRun/FemRun) | 公開詞彙與用語線索，包括公開 Issues 中的用語線索 |

## 權利與引用說明

- 列出來源不代表來源作者或維護者認可、贊助或參與本專案。
- 本專案未取得上述儲存庫內容的再授權，也不會因列出來源而聲稱已取得授權。
- 上述儲存庫的著作權、授權條款與其他權利仍分別歸其權利人所有；使用者如需引用原內容，應直接查閱各來源的現行條款。
- 本專案未再發布上述來源的文章、長篇內容、原始檔案、畫面截圖或個人識別資訊。
